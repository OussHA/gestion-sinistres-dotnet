    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssuranceID = table.Column<int>(type: "integer", nullable: false)
                    ...
                    SiteWeb = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nom = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Services = table.Column<string>(type: "text", nullable: true),
                    TarifNormal = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    TarifSoirWeekendFerie = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    Agences = table.Column<string>(type: "text", nullable: true),
                    Contact = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Mail = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    AdresseSiege = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CodePostalSiege = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    VilleSiege = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Horaires = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    SiteWeb = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Note = table.Column<decimal>(type: "numeric(3,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotDePasseHash = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodePostal = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Ville = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    AssuranceID = table.Column<int>(type: "integer", nullable: true),
                    TypeAssurance = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeSinistre = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Priorite = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Etat = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    CommentaireISH = table.Column<string>(type: "text", nullable: true),
                    CommentaireAssurance = table.Column<string>(type: "text", nullable: true),
                    CommentairePrestataire = table.Column<string>(type: "text", nullable: true),
                    UtilisateurID = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MontantHT = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    MontantTVA = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    MontantTTC = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoriqueID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DossierID = table.Column<int>(type: "integer", nullable: true),
                    ChampModifie = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    AncienneValeur = table.Column<string>(type: "text", nullable: true),
                    NouvelleValeur = table.Column<string>(type: "text", nullable: true),
                    DateModification = table.Column<DateOnly>(type: "timestamp with time zone", nullable: true, defaultValueSql: "(NOW())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModificationID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DossierID = table.Column<int>(type: "integer", nullable: true),
                    DateModification = table.Column<DateOnly>(type: "timestamp with time zone", nullable: true),
                    TypeModification = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    Commentaire = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PieceJointeID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DossierID = table.Column<int>(type: "integer", nullable: true),
                    NomFichier = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    TypeFichier = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    CheminFichier = table.Column<string>(type: "text", nullable: true),
                    DateAjout = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "(NOW())"),
                    Contenu = table.Column<byte[]>(type: "bytea", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recu = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    MontantRestant = table.Column<decimal>(type: "numeric(10,2)", nullable: true)
                },
                constraints: table =>
                {
